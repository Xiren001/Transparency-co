...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="font-milk flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 px-8 tracking-tighter text-[#1b1b18] uppercase lg:justify-center lg:py-6 dark:bg-[#0a0a0a]">
                <header className="mb-6 w-full max-w-[1000px] text-sm not-has-[nav]:hidden lg:max-w-[2000px]">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[1000px] flex-col-reverse lg:max-w-[2000px] lg:flex-row">
