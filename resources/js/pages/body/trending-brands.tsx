...
export default function TrendingBrands() {
    ...
    return (
        <section className="rounded-lg border-gray-100 bg-[#ecf0f3] pt-2 pb-12 dark:border-[#2d2d35] dark:bg-[#181a1b]">
            <div className="container mx-auto px-4">
                ...
                <div className="relative overflow-hidden">
                    ...
                    <div className="pointer-events-none absolute top-0 bottom-0 left-0 z-10 w-20 bg-gradient-to-r from-[#ecf0f3] to-transparent dark:from-[#181a1b]"></div>
                    <div className="pointer-events-none absolute top-0 right-0 bottom-0 z-10 w-20 bg-gradient-to-l from-[#ecf0f3] to-transparent dark:from-[#181a1b]"></div>
