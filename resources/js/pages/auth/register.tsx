        ...
        <AuthLayout title="Create an account" description="Enter your details below to create your account">
            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                ...
                <div className="grid gap-6">
                    ...
                    <Button
                        type="submit"
                        className="mt-2 w-full rounded-[8px] border-0 bg-[#ecf0f3] text-gray-900 shadow-[4px_4px_8px_#d1d9e6,-4px_-4px_8px_#ffffff] hover:shadow-[2px_2px_4px_#d1d9e6,-2px_-2px_4px_#ffffff] active:shadow-[inset_2px_2px_4px_#d1d9e6,inset_-2px_-2px_4px_#ffffff] disabled:opacity-50 disabled:shadow-none dark:bg-[#181a1b] dark:text-gray-100 dark:shadow-[4px_4px_8px_#0e0f10,-4px_-4px_8px_#222526] dark:hover:shadow-[2px_2px_4px_#0e0f10,-2px_-2px_4px_#222526] dark:active:shadow-[inset_2px_2px_4px_#0e0f10,inset_-2px_-2px_4px_#2a2d2e]"
                        tabIndex={5}
                        disabled={processing}
                    >
